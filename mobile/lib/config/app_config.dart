...
class AppConfig {
  ...
  factory AppConfig.load() {
    ...
    final env = Platform.environment['VSL_ENV'] ??
                Platform.environment['FLUTTER_APP_ENV'] ??
                'dev';

    final urlOverride = Platform.environment['VSL_SERVER_URL'] ??
                       Platform.environment['SERVER_URL'];

    final portOverride = Platform.environment['VSL_SERVER_PORT'] ??
  ...
  @override
  String toString() {
    return 'AppConfig(environment: $environment, serverUrl: $serverUrl, serverPort: $serverPort, useMockMediaPipe: $useMockMediaPipe)';
  }
}
